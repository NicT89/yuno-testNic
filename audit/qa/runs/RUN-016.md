# QA Probe Run 016 — 2026-08-06T01:05:26.147Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 37 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 29 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 205.92ms over 44 requests
(previous 103.58ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 37; QA-002 29; QA-003 14 daily runs.
