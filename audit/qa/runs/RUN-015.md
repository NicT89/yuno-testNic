# QA Probe Run 015 — 2026-08-06T00:05:31.592Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 36 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 28 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 103.58ms over 45 requests
(previous 76.83ms); there were no network errors or 5xx responses. This
...
(94887 category tax and total tax; 1602 bps average on 592228 base).

Consecutive-failure watchlist: QA-001 36; QA-002 28; QA-003 14 daily runs.
