# QA Probe Run 006 — 2026-08-05T15:07:22Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 27 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 19 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 122.41ms over 42 requests
(previous 141.83ms); there were no network errors or 5xx responses. The local
...
Consecutive-failure watchlist: QA-001 27; QA-002 19; QA-003 14 daily runs.
