# QA Probe Run 020 — 2026-08-06T05:04:20.691Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 41 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 33 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 132.72ms over 44 requests
(previous 114.87ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 41; QA-002 33; QA-003 14 daily runs.
