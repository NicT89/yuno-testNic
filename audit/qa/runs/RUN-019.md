# QA Probe Run 019 — 2026-08-06T04:05:59.949Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 40 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 32 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 114.87ms over 44 requests
(previous 408.84ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 40; QA-002 32; QA-003 14 daily runs.
