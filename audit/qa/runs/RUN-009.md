# QA Probe Run 009 — 2026-08-05T18:22:49Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 30 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 22 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 449.22ms over 44 requests
(previous 512.91ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 30; QA-002 22; QA-003 14 daily runs.
