# QA Probe Run 011 — 2026-08-05T20:07:47Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 32 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 24 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 193.32ms over 44 requests
(previous 99.63ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 32; QA-002 24; QA-003 14 daily runs.
