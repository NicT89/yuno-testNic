# QA Probe Run 013 — 2026-08-05T22:06:40Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 34 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 26 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 3187.26ms over 43 requests
(previous 171.48ms); there were no network errors or 5xx responses. The
single-run increase is recorded as cold-start/network noise, not an engine NFR
failure; the local engine p99 baseline remains 1.609ms.
...
Consecutive-failure watchlist: QA-001 34; QA-002 26; QA-003 14 daily runs.
