# QA Probe Run 017 — 2026-08-06T02:05:32.200Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 38 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 30 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 160.69ms over 44 requests
(previous 205.92ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 38; QA-002 30; QA-003 14 daily runs.
