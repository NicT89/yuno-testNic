# QA Probe Run 023 — 2026-08-06T08:07:40.123Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 44 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 36 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 116.72ms over 50 read requests
(previous 68.88ms); there were no network errors or 5xx responses across 94
...
Consecutive-failure watchlist: QA-001 44; QA-002 36; QA-003 15 daily runs.
