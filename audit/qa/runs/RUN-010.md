# QA Probe Run 010 — 2026-08-05T19:16:12Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 31 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 23 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 99.63ms over 44 requests
(previous 449.22ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 31; QA-002 23; QA-003 14 daily runs.
