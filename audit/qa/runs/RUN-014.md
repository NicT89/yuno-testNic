# QA Probe Run 014 — 2026-08-05T23:05:57Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 35 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 27 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 76.83ms over 45 requests
(previous 3187.26ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 35; QA-002 27; QA-003 14 daily runs.
