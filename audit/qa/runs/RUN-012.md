# QA Probe Run 012 — 2026-08-05T21:10:54Z — tier: hourly
...
## Escalated
None this run. QA-001 remains P0 at 33 consecutive failures: an unknown BR
category returned 200 and 1700 tax through `BR:*:ICMS@v1`, not 422
`NO_APPLICABLE_RULE`. QA-002 remains P0 at 25 consecutive failures: a
...
## Trend
Production network-inclusive latency p99 was 171.48ms over 44 requests
(previous 193.32ms); there were no network errors or 5xx responses. This
...
Consecutive-failure watchlist: QA-001 33; QA-002 25; QA-003 14 daily runs.
