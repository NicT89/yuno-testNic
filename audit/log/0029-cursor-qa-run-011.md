# 0029 — cursor — QA probe run 011

**When:** 2026-08-05T20:07:47Z
**Agent:** cursor
**Task:** QA probe run 011 (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-011.md, audit/ACTIVE.md
...
signatures failed. Network-inclusive p99 was 193.32ms.

## For the next agent
Continue with run 012 from `audit/qa/STATE.json`. Reuse the fixed request bodies:
