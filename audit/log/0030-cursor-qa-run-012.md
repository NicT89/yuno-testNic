# 0030 — cursor — QA probe run 012

**When:** 2026-08-05T21:10:54Z
**Agent:** cursor
**Task:** QA probe run 012 (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-012.md, audit/ACTIVE.md
...
signatures failed. Network-inclusive p99 was 171.48ms.

## For the next agent
Continue with run 013 from `audit/qa/STATE.json`. Reuse the fixed request bodies:
