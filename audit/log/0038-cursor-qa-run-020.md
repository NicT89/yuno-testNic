# 0038 — cursor — QA probe run 020

**When:** 2026-08-06T05:04:20.691Z
**Agent:** cursor
**Task:** QA probe run 020 (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-020.md, audit/ACTIVE.md
...
network-inclusive p99 was 132.72ms.

## For the next agent
Continue from run 020. Failure counts are QA-001 41, QA-002 33, and QA-003
