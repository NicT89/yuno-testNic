# 0035 — cursor — QA probe run 017

**When:** 2026-08-06T02:05:32.200Z
**Agent:** cursor
**Task:** QA probe run 017 (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-017.md, audit/ACTIVE.md
...
network-inclusive p99 was 160.69ms.

## For the next agent
Continue from run 017. Failure counts are QA-001 38, QA-002 30, and QA-003
