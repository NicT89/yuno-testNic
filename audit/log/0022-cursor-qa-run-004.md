# 0022 — cursor — QA probe run 004

**When:** 2026-08-05T13:04:43Z
**Agent:** cursor
**Task:** Hourly QA probe (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-004.md, audit/ACTIVE.md

## What changed
Recorded hourly run 004 against production. No new signature appeared:
...
## For the next agent
Carry forward QA-001 at 25 consecutive failures, QA-002 at 17, and QA-003 at
