# 0036 — cursor — QA probe run 018

**When:** 2026-08-06T03:04:40.845Z
**Agent:** cursor
**Task:** QA probe run 018 (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-018.md, audit/ACTIVE.md
...
network-inclusive p99 was 408.84ms.

## For the next agent
Continue from run 018. Failure counts are QA-001 39, QA-002 31, and QA-003
