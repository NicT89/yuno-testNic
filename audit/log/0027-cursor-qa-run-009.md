# 0027 — cursor — QA probe run 009

**When:** 2026-08-05T18:22:49Z
**Agent:** cursor
**Task:** QA probe run 009 (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-009.md, audit/ACTIVE.md
...
signatures failed. Network-inclusive p99 was 449.22ms.

## For the next agent
Continue with run 010 from `audit/qa/STATE.json`. Reuse the fixed request bodies:
