# 0031 — cursor — QA probe run 013

**When:** 2026-08-05T22:06:40Z
**Agent:** cursor
**Task:** QA probe run 013 (`docs/13-QA-PROBE-AGENT.md`)
**Findings touched:** F-039, F-040, F-041
**Files changed:** audit/qa/STATE.json, audit/qa/LATEST.md, audit/qa/runs/RUN-013.md, audit/ACTIVE.md
...
## Verified how
43 production requests: 18/20 checks passed, with no network errors or 5xx.
...
signatures failed. Network-inclusive p99 was 3187.26ms.

## For the next agent
Continue with run 014 from `audit/qa/STATE.json`. Reuse the fixed request bodies:
